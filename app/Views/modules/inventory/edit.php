...
<?php //echo "<pre>"; print_r($inventory_data); die; ?>
<main id="main">
    <div class="row main-inner" style="margin-left: 20px;">
        <form name="editListingForm" id="addListingForm" method="POST">
            <input type="hidden" name="inventory_id" value="<?php echo $inventory_data[0]['inventory_id']; ?>">
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="vendor_name" placeholder="" name="vendor_name"
                    value="<?php echo $inventory_data[0]['vendor']; ?>">
            </div>
            <div class="col-md-2">
                <label for="field1" class="form-label">Invoice Number</label>
                <input type="text" class="form-control" id="invoice_id" placeholder="" name="invoice_id" value="<?php echo $inventory_data[0]['invoice_id']; ?>">
            </div>
            <div class="container mt-6">
                <?php $row_count = 1; ?>
                <?php $item_count = 1; ?>
                <?php //echo $inventory_data[$item_count]['id'];  die; ?>   
            
                <?php foreach($inventory_data AS $inventory_items){    ?>
                   
                <?php if($row_count  == 1){ ?>
                    <div id="row_<?php echo $row_count; ?>" class="row mb-3 align-items-center">
                                <div class="col-md-2">
                                    <label for="field1" class="form-label">Item</label>
                                    <input type="hidden" class="id" id="id" placeholder="" name="item_id[]"
                                        value="<?php echo $inventory_data[0]['id']; ?>" autocomplete="off"> 
                                    <input type="text" class="item_name form-control" id="item_name" placeholder="" name="item_name[]"
                                        value="<?php echo $inventory_data[0]['item_name']; ?>" autocomplete="off">
                                    <input type="hidden" class="item_id" id="item_id" placeholder="" name="item_id[]"
                                        value="<?php echo $inventory_data[0]['item_id']; ?>" autocomplete="off">   
                                </div>
                                <div class="col-md-1">
                                    <label for="field2" class="form-label">Unit</label>
                                    <input type="text" class="form-control unit bc" id="unit" placeholder="" name="unit[]" value="<?php echo $inventory_data[0]['unit_type']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1" style="width: 120px;">
                                    ...
                                    <input type="text" class="form-control hsd_code bc" id="hsd_code" placeholder="" name="HSN_code[]"
                                        value="<?php echo $inventory_data[0]['HSN_code']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1">
                                    <label for="field2" class="form-label">SGST</label>
                                    <input type="text" class="form-control sgst_tax_rate bc" id="sgst_tax_rate" placeholder="" name="sgst_tax_rate[]"value="<?php echo $inventory_data[0]['sgst_tax_rate']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1">
                                    <label for="field2" class="form-label">CGST</label>
                                    <input type="text" class="form-control cgst_tax_rate bc" id="cgst_tax_rate" placeholder="" name="cgst_tax_rate[]" value="<?php echo $inventory_data[0]['cgst_tax_rate']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1">
                                    <label for="field2" class="form-label">QTY</label>
                                    <input type="text" class="form-control qty" id="qty" placeholder="" name="quantity[]" value="<?php echo $inventory_data[0]['quantity']; ?>" autocomplete="off">
                                </div>
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="text" class="form-control buy_price" id="buy_price" placeholder="" name="buy_price[]"
                                        value="<?php echo $inventory_data[0]['buy_price']; ?>" autocomplete="off">
                                </div>
                                <div class="col-md-1" style="width: 120px;">
                                    <label for="field3" class="form-label">SGST Value</label>
                                    <input type="text" class="form-control sgst_tax_value bc" id="sgst_tax_value" placeholder="" name="sgst_tax_value[]" value="<?php echo $inventory_data[0]['sgst_tax_value']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1" style="width: 120px;">
                                    <label for="field3" class="form-label">CGST Value</label>
                                    <input type="text" class="form-control cgst_tax_value bc" id="cgst_tax_value" placeholder="" name="cgst_tax_value[]" value="<?php echo $inventory_data[0]['cgst_tax_value']; ?>" autocomplete="off" readonly>
                                </div>
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="text" class="form-control mrp_price" id="mrp_price" placeholder="" name="mrp_price[]"
                                        value="" autocomplete="off" <?php echo $inventory_data[0]['net_value']; ?>>
                                </div>
                                <div class="col-md-1">
                                    ...
                                    <input type="text" class="form-control net_value bc" id="net_value" placeholder=""
                                        name="net_value[]" value="<?php echo $inventory_data[0]['net_value']; ?>" autocomplete="off" readonly>
                                </div>
                ...
                <?php } else{ ?>
                    <div id="row_<?php echo $row_count; ?>" class="row mb-3 align-items-center">
                                ...
                                <div class="col-md-2">
                                    <input type="hidden" class="id" id="id" placeholder="" name="item_id[]"
                                        value="<?php echo $inventory_data[$item_count]['id']; ?>" autocomplete="off"> 
                                    <input type="text" class="item_name form-control" id="item_name" placeholder="" name="item_name[]"
                                        value="<?php echo $inventory_data[$item_count]['item_name']; ?>" autocomplete="off">
                                    <input type="hidden" class="item_id" id="item_id" placeholder="" name="item_id[]"
                                        value="<?php echo $inventory_data[$item_count]['item_id']; ?>" autocomplete="off">   
                                </div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control unit bc" id="unit" placeholder="" name="unit[]" value="<?php echo $inventory_data[$item_count]['unit_type']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1" style="width: 120px;">
                                    <input type="text" class="form-control hsd_code bc" id="hsd_code" placeholder="" name="HSN_code[]"
                                        value="<?php echo $inventory_data[$item_count]['HSN_code']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control sgst_tax_rate bc" id="sgst_tax_rate" placeholder="" name="sgst_tax_rate[]"value="<?php echo $inventory_data[$item_count]['sgst_tax_rate']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control cgst_tax_rate bc" id="cgst_tax_rate" placeholder="" name="cgst_tax_rate[]" value="<?php echo $inventory_data[$item_count]['cgst_tax_rate']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control qty" id="qty" placeholder="" name="quantity[]" value="<?php echo $inventory_data[$item_count]['quantity']; ?>" autocomplete="off">
                                </div>
                            
                                <div class="col-md-1">
                                    <input type="text" class="form-control buy_price" id="buy_price" placeholder="" name="buy_price[]"
                                        value="<?php echo $inventory_data[$item_count]['buy_price']; ?>" autocomplete="off">
                                </div>
                                <div class="col-md-1" style="width: 120px;">
                                    <input type="text" class="form-control sgst_tax_value bc" id="sgst_tax_value" placeholder="" name="sgst_tax_value[]" value="<?php echo $inventory_data[$item_count]['sgst_tax_value']; ?>" autocomplete="off" readonly>
                                </div>
                                <div class="col-md-1" style="width: 120px;">
                                    <input type="text" class="form-control cgst_tax_value bc" id="cgst_tax_value" placeholder="" name="cgst_tax_value[]" value="<?php echo $inventory_data[$item_count]['cgst_tax_value']; ?>" autocomplete="off" readonly>
                                </div>

                                <div class="col-md-1">
                                    <input type="text" class="form-control mrp_price" id="mrp_price" placeholder="" name="mrp_price[]"
                                        value="" autocomplete="off" <?php echo $inventory_data[$item_count]['net_value']; ?>>
                                </div>
                                <div class="col-md-1">
                                    <input type="text" class="form-control net_value bc" id="net_value" placeholder=""
                                        name="net_value[]" value="<?php echo $inventory_data[$item_count]['net_value']; ?>" autocomplete="off" readonly>
                                </div>
